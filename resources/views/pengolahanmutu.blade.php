        ...
        <table class="table" style="width: 100%">
            <thead>
                <tr>
                    <th>Kode</th>
                    <th>Dokumen</th>
                    <th style="width: 70px">Sasaran</th>
                ...
                @foreach ($laporans as $laporan)
                    <tr>
                        ...
                        <td style="text-align: center">
                            @if ($laporan->sasaran == 'Internal')
                                <span class="sasaran internal">Internal</span>
                            @else
                                <span class="sasaran public">Public</span>
                            @endif
                        </td>
                        <td style="text-align: center">
                            ...
                            @if ($laporan->sasaran == 'Internal')
                                <a>
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" style="width: 25px; color:rgb(163, 163, 163)"
                            ...
                            @else
                                <a>
                                    <svg xmlns="http://www.w3.org/2000/svg" style="width: 25px; color:rgb(76, 157, 250)  "
                                        fill="currentColor" viewBox="0 0 640 640">
                                        <path
...
<style>
    ...
    th {
        background-color: rgb(35, 113, 177);
        color: white;
    }
    ...
    .internal {
        background-color: rgb(241, 210, 141);
        color: white;
    }
