...
@section('content')
    <div class="container">
        <h1>Create Audit Instrument</h1>

        <form action="{{ route('audit-instruments.store') }}" method="POST">
            @csrf
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="instrument_code" class="form-control" value="{{ old('instrument_code') }}"
                    ...
                    <div class="mb-3">
                        ...
                        <select name="standar_id" class="form-control">
                            <option value="">-- Not Linked to Standar --</option>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select name="evidence_type" class="form-control" required>
                            ...
                            <option value="dokumen" {{ old('evidence_type') == 'dokumen' ? 'selected' : '' }}>Dokumen
                            </option>
                            <option value="observasi" {{ old('evidence_type') == 'observasi' ? 'selected' : '' }}>Observasi
                            </option>
                            <option value="wawancara" {{ old('evidence_type') == 'wawancara' ? 'selected' : '' }}>Wawancara
                            </option>
                        </select>
                        @error('evidence_type')
                            <div class="text-danger">{{ $message }}</div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" name="weight" class="form-control"
                            value="{{ old('weight', 1.0) }}" min="0" required>
                        @error('weight')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
