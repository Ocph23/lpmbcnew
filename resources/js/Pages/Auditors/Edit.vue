<!-- resources/js/Pages/Auditors/Edit.vue -->
<script setup>
...
const form = useForm({
    name: props.auditor.name,
    email: props.auditor.email,
    phone: props.auditor.phone,
    kategori: props.auditor.kategori,
})

const submit = () => {
    form.put(route('auditors.update', props.auditor.id), {
        preserveScroll: true,
    })
}
...
const kategoriOptions = [
    ...
    { value: 3, label: 'Lembaga Independen' },
]
</script>
    ...
    <AdminLayout>
        <div class="p-6 max-w-2xl mx-auto">
            <div class="flex items-center mb-6">
                <h1 class="text-2xl font-bold">Edit Auditor</h1>
            </div>
