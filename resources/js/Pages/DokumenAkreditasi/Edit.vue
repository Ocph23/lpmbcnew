<!-- resources/js/Pages/DokumenAkreditasi/Edit.vue -->
<script setup>
...
const form = useForm({
    auditi_id: props.dokumenAkreditasi.auditi_id,
...
const submit = () => {
    form.put(route('dokumen-akreditasi.update', props.dokumenAkreditasi.id), {
        preserveScroll: true,
    })
}
