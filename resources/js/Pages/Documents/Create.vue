...
const submit = () => {
    form.post(route('documents.store', props.param), {
        forceFormData: true,
        preserveScroll: true,
    })
}
    ...
    <AdminLayout>
        <div class="p-6 max-w-3xl mx-auto">
            <div class="flex items-center mb-6">
                <h1 class="text-2xl font-bold ">Tambah {{helper.downloadOptions.find(x => x.kode ==
                    props.param).kategori}}
                </h1>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="flex gap-3 pt-4">
                    ...
                    <Link :href="route('documents.index', props.param)"
