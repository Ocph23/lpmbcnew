<!-- resources/js/Pages/InstrumenAkreditasis/Index.vue -->
<script setup>
...
watch(search, (newVal) => {
    ...
    searchTimeout = setTimeout(() => {
        router.get(route('instrumen-akreditasis.index'), { search: newVal || null }, {
            preserveState: true,
            replace: true,
        })
    }, 300)
...
const destroy = (id) => {
    if (confirm('Yakin hapus dokumen ini?')) {
        router.delete(route('instrumen-akreditasis.destroy', id))
    }
}
</script>
    ...
    <AdminLayout>
        <div class="p-2">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-bold">Instrument Akreditasi</h1>
                <VTButtonAction v-if="isAdmin" :url="route('instrumen-akreditasis.create')" :style="'success'">
                    <VTIconPlus />
                </VTButtonAction>
            </div>
            <!-- Pencarian -->
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr v-for="doc in InstrumenAkreditasis" :key="doc.id">
                            ...
                            <td
                                ...
                                <ActionComponent :is-authenticated="isAdmin">
                                    <VTButtonAction :url="route('instrumen-akreditasis.edit', doc.id)" :type="'edit'"
                                        :style="'warning'" />
                        ...
                        <tr v-if="InstrumenAkreditasis?.length === 0">
