...
const props = defineProps({ periodes: Array, monev: Object })
const form = useForm({
    kode_monev: props.monev.kode_monev || '',
    nama_monev: props.monev.nama_monev || '',
    periode_id: props.monev.periode_id || null,
    status: props.monev.status || 'Akademik',
    document: null,
    document_path: props.monev.document_path || '',
})
const route = window.route;
const submit = () => {
    form.post(route('monevs.update', props.monev.id), {
    ...
    <AdminLayout>
        <div class="p-6 max-w-2xl mx-auto">
            <div class="flex items-center mb-6">
                <h1 class="text-2xl font-bold ml-3">Edit Monev</h1>
            </div>
