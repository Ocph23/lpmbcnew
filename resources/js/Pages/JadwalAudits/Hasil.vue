<!-- resources/js/Pages/JadwalAudits/hasil.vue -->
<script setup>
...
watch(periodeFilter, (newVal) => {
    router.get(route('jadwal-audits.hasil'), { periode_id: newVal || null }, {
        preserveState: true,
        replace: true,
    })
})
    ...
    <AdminLayout>
        <div class="p-2">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-bold">Hasil Audit</h1>
            </div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr v-for="jadwal in jadwalAudits" :key="jadwal.id">
                            ...
                            <td class="text-center">
                                <DownloadComponent :link="'/storage/' + jadwal.document_path" />
                            </td>
                            <td
