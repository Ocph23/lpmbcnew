<template>
    <div @click="openMenu" :class="[
        ...
        <div class="flex gap-2" @click="getData()">
            <slot name="icon"></slot>
...
const getData = () => {
    const form = useForm(
        { kode: props.param.kode, kategori: props.param.kategori, unit: props.param.unit }
    );
    form.post(route('dokumen-mutus.filter', props.param.kategori), {
        forceFormData: true,
        preserveScroll: true,
    })
}
